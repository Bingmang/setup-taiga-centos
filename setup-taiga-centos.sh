...
STATIC_URL = "http://YOURURL/static/"
ADMIN_MEDIA_PREFIX = "http://YOURURL/static/admin/"
SITES["front"]["domain"] = "YOURURL"
DEBUG = False
...
git checkout stable
cd dist/
sed -e 's/http:\/\/localhost:8000//g' conf.example.json > conf.json
...
#run
su taiga -c "python3.5 /home/taiga/taiga-back/manage.py runserver 127.0.0.1:8001 &"
